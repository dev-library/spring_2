...
public class MVCController {
	...
	public String bmiResult(@RequestParam("height") int cm, int kg, Model model) {
		double m = cm / 100.0;
		double bmi = kg / (m * m);
	...
	// rest방식으로 url을 처리할대 주로 사용하는 방식입니다.
	...
	//void리턴을 하는 컨트롤러 메서드는 RequestMapping에 적힌 주소와 일치하는 이름의 .jsp로 연결됩니다.
	@RequestMapping("/spring")
	public void spring() {
		System.out.println("/spring 주소 감지");
	}
	
	// 동일한 이름의 파라미터가 여럿 전달되는 경우는 ArrayList<>, String[] 등을 ㅇ용해 처리가 가능합니다.
	@GetMapping("/list")
	...
	// 같은 효과를 볼 수 있습니다.
	// 즉 ?age=000&name=0000 라고 적는 데이터를 받아올 수 있습니다.
	@GetMapping("/getVO")
